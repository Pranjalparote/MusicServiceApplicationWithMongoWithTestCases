...
public class MusicController {
  ...
  /*  @RequestMapping(value = "music/{musicName}", method = RequestMethod.GET)
    public ResponseEntity<List<Music>> getMusicByName(@PathVariable("musicName") String musicName) throws MusicNotFoundException {
        List<Music> musicOne = musicService.getMusicByName(musicName);
        return new ResponseEntity<List<Music>>(musicOne, HttpStatus.OK);
    }*/
